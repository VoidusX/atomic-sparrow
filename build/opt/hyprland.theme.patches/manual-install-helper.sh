#!/usr/bin/env bash
# Original file: https://github.com/EisregenHaha/fedora-hyprland/blob/f42/manual-install-helper.sh
# Modified to patch for Sparrow @ hyprland.theme.patches
#
# This script is for installing/updating some "packages" for non-Arch users.
#
# NOTES: install-python-packages cannot be used as python latest and 3.12 can't be installed on image due to anaconda installer issues.
